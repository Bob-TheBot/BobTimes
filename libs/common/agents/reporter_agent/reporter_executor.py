...
class ReporterTaskExecutor:
    ...
    def _check_research_limits(self, state: ReporterState, task: JournalistTask) -> bool:
    ...
    async def _handle_tool_execution(self, tool_call: StoryToolCall, state: ReporterState) -> None:
        ...
        # Handle fetch_from_memory tool results explicitly
        if tool_result.success and tool_call.name == "fetch_from_memory":
