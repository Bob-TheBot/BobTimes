    ...
    def _ensure_file(self) -> None:
        if not self.path.exists():
            ...
            data = StoreData(
                stories={},
                front_page=[],
                sections={field.value: [] for field in ReporterField},
                metadata=StoreMetadata(
...
class CollectTopicsResult(BaseModel):
    ...
    topics_by_field: dict[ReporterField, list[str]]
    success: bool
    error: str | None = None
...
def empty_topics_collected() -> dict[ReporterField, list[str]]:
...
def empty_reporters() -> dict[str, ReporterField]:
...
"""
    ...
    def _create_image_prompt(self, title: str, field: ReporterField) -> str:
        ...
        """
        field_styles = {
            ReporterField.TECHNOLOGY: "modern technology, digital innovation, sleek design",
            ReporterField.SCIENCE: "scientific research, laboratory setting, discovery theme",
            ReporterField.ECONOMICS: "business analytics, financial data, corporate environment"
        }
