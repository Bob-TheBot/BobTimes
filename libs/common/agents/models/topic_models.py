...
from ..types import JournalistField
...
class SelectedTopicList(BaseModel):
    ...
    rejected_topics: dict[JournalistField, list[str]] = Field(default_factory=_empty_rejected_topics)


class TopicSelectionRequest(BaseModel):
    """Request for topic selection by editor."""
    proposals_by_field: dict[JournalistField, list[str]]
